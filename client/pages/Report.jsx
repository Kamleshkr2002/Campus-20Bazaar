  ...
  const reportTypes = [
    {
      value: "scam",
      label: "Scam or Fraud",
      description: "Suspicious payment requests, fake items, or fraudulent behavior",
      icon: Shield,
      severity: "high"
    },
    {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Help us keep CampusMarket safe and secure by reporting any issues, violations, or concerns you encounter.
          </p>
        </div>
        ...
        <Alert className="mb-8 border-red-200 bg-red-50">
          ...
          <AlertDescription className="text-red-800">
            <strong>Emergency?</strong> If you're in immediate danger or experiencing a serious threat, call 911 or campus security immediately.
          </AlertDescription>
        </Alert>
        ...
        {isSubmitted && (
          <Alert className="mb-8 border-green-200 bg-green-50">
            ...
            <AlertDescription className="text-green-800">
              <strong>Report submitted successfully!</strong> We take all reports seriously and will investigate promptly. You'll receive updates via email if you provided contact information.
            </AlertDescription>
          </Alert>
        )}
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-start space-x-3">
                              <IconComponent className={`w-5 h-5 mt-1 ${isSelected ? 'text-primary' : 'text-muted-foreground'}`} />
                              <div>
                                ...
                                <Badge 
                                  variant={type.severity === 'high' ? 'destructive' : type.severity === 'medium' ? 'secondary' : 'outline'}
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="userReported">User/Seller Involved (optional)</Label>
                          <Input
                            id="userReported"
                            type="text"
                            value={formData.userReported}
                            onChange={(e) => handleInputChange("userReported", e.target.value)}
                      ...
                      {/* Severity */}
                      <div className="space-y-2">
                        <Label htmlFor="severity">How urgent is this issue?</Label>
                        <Select onValueChange={(value) => handleInputChange("severity", value)} defaultValue="medium">
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="low">Low - Minor issue or policy violation</SelectItem>
                            <SelectItem value="medium">Medium - Concerning behavior or content</SelectItem>
                            <SelectItem value="high">High - Safety threat or significant violation</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                          We may contact you for clarification or updates on your report
                        </p>
                      </div>
                ...
                <div className="space-y-4">
                  {emergencyContacts.map((contact, index) => (
                    <div key={index} className="border-l-2 border-red-300 pl-3">
                      <h4 className="font-medium text-red-900 text-sm">{contact.situation}</h4>
                      <p className="text-red-800 font-semibold text-sm">{contact.contact}</p>
                      <p className="text-red-700 text-xs">{contact.description}</p>
                    </div>
                  ))}
                </div>
              </CardContent>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Our team reviews your report within 24 hours</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">We investigate and gather additional information if needed</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">You'll receive an update if you provided contact info</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  You can submit reports anonymously. However, providing contact information helps us:
                </p>
