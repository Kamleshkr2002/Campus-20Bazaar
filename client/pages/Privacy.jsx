      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Alert className="mb-8 border-blue-200 bg-blue-50">
          ...
          <AlertDescription className="text-blue-800">
            <strong>TL;DR:</strong> We only collect information necessary to run the marketplace safely. 
            We don't sell your data to third parties. You control your information and can delete your account anytime.
          </AlertDescription>
        </Alert>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <Card className="text-center">
            <CardHeader>
              ...
              <CardDescription>
                We only collect information that's necessary for the marketplace to function safely and effectively.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="text-center">
            <CardHeader>
              ...
              <CardDescription>
                You decide what information to share and can update, download, or delete your data at any time.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="text-center">
            <CardHeader>
              ...
              <CardDescription>
                We're clear about what data we collect, how we use it, and who we share it with (spoiler: very few people).
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
            ...
            <CardContent>
              <div className="space-y-4">
                <p className="text-muted-foreground">
                  As a student-focused platform, we take extra steps to protect your academic privacy:
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start space-x-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2.5 flex-shrink-0"></div>
                    <span className="text-muted-foreground">
                      We never share your academic information with non-university entities
                    </span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2.5 flex-shrink-0"></div>
                    <span className="text-muted-foreground">
                      Your student status is verified securely without exposing personal details
                    </span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2.5 flex-shrink-0"></div>
                    <span className="text-muted-foreground">
                      University partnerships are limited to verification purposes only
                    </span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2.5 flex-shrink-0"></div>
                    <span className="text-muted-foreground">
                      Data is automatically deleted when you graduate or leave the university
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <CardContent className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <p className="text-primary font-medium">{contactInfo.email}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-primary font-medium">{contactInfo.phone}</p>
                </div>
              </div>
