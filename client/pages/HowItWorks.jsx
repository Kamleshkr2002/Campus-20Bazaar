  ...
  const steps = {
    buying: [
      ...
      },
      {
        ...
        description:
          "Rate your experience to help build trust in our community",
        icon: Star,
        details: [
    ...
    selling: [
      {
        ...
        description:
          "Upload photos and write a detailed description of your item",
        icon: Camera,
        details: [
  ...
  const features = [
    {
      ...
      description:
        "All users must verify their student status with a valid .edu email or student ID.",
    ...
    },
    {
      ...
      description:
        "All communication happens through our secure platform messaging system.",
    ...
    },
    {
      ...
      title: "Smart Search",
      description:
        "Advanced search filters help you find exactly what you're looking for quickly.",
    ...
    },
    {
      ...
      description:
        "Save items you like and get notified when similar items are posted.",
    ...
    },
    {
      ...
      title: "Rating System",
      description:
        "User ratings and reviews help you make informed decisions about who to trade with.",
    ...
    },
    {
      ...
      title: "Quick Listing",
      description:
        "Create listings in under 2 minutes with our streamlined posting process.",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Your complete guide to buying and selling safely within the student
            community. Join thousands of students who trust CampusMarket for
            their campus trading needs.
          </p>
        </div>
        ...
        <Alert className="mb-12 border-blue-200 bg-blue-50">
          ...
          <AlertDescription className="text-blue-800">
            <strong>New to CampusMarket?</strong> Start by verifying your
            student status, then browse items or create your first listing. All
            transactions happen directly between students - we just provide the
            platform to connect you safely.
          </AlertDescription>
        </Alert>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="text-center">
              <CardHeader>
                ...
                <CardDescription>
                  Create an account using your student email (.edu) to get
                  verified
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center">
              <CardHeader>
                ...
                <CardDescription>
                  Browse items or create listings to start trading with fellow
                  students
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center">
              <CardHeader>
                ...
                <CardDescription>
                  Meet in public campus areas and build your reputation in the
                  community
                </CardDescription>
              </CardHeader>
            </Card>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We've built features specifically for the student community to
              make trading safe, easy, and trustworthy.
            </p>
          </div>
        ...
        <Card className="bg-primary/5 border-primary/20">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              ...
              finding great deals on CampusMarket. Whether you're looking to buy
              textbooks or sell furniture, we make it safe and easy.
            </p>
