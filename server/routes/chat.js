...
import { uploadMessageAttachments, handleUploadError } from '../middleware/upload.js';
import { validateMessageCreation, validatePagination, validateObjectId, handleValidationErrors } from '../middleware/validation.js';
...
// Update offer status
router.patch('/messages/:id/offer',
  authenticate,
  validateObjectId('id'),
  handleValidationErrors,
  catchAsync(async (req, res) => {
...
// Block conversation
router.patch('/conversations/:id/block',
  authenticate,
  validateObjectId('id'),
  handleValidationErrors,
  catchAsync(async (req, res) => {
...
router.patch('/conversations/:id/unblock',
  authenticate,
  validateObjectId('id'),
  handleValidationErrors,
  catchAsync(async (req, res) => {
