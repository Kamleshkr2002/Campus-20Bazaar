...
import { authenticate, authRateLimit, passwordResetRateLimit, emailVerificationRateLimit } from '../middleware/index.js';
...
router.post('/register', 
  ...
  catchAsync(async (req, res) => {
    const { firstName, lastName, email, password, university, studentId, phone } = req.body;
    ...
    if (existingStudent) {
      throw new AppError('Student ID already registered at this university', 400);
    }
