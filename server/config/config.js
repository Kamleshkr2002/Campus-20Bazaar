...
export const config = {
  ...
  // Database
  mongodbUri:
    process.env.MONGODB_URI || "mongodb://localhost:27017/campusbazaar",
  mongodbUriTest:
    process.env.MONGODB_URI_TEST ||
    "mongodb://localhost:27017/campusbazaar_test",
  ...
  // Socket.io
  socketIoCorsOrigin:
    process.env.SOCKET_IO_CORS_ORIGIN || "http://localhost:8080",
